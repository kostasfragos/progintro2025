# progintro2025
## This repo contains the solution to every single exercise of the course "progintro" of the season 2025-2026 in NTUA.

- Some of the ".cpp" files use "pzhelp" to make the code simpler. If you wanna download and run them: download the file "pzhelp", remove the extension (if it has one) and place it in the folder your ".cpp" files are in.
